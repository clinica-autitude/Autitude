...
import { mergeProps, withCtx, createTextVNode, createVNode, resolveDynamicComponent, openBlock, createBlock, toDisplayString, defineComponent, useTemplateRef, ref, watch, computed, useSSRContext } from 'vue';
...
import { Heart, Brain, Sparkles, HandHeart, BookOpen, Mic, Activity, Puzzle } from 'lucide-vue-next';
