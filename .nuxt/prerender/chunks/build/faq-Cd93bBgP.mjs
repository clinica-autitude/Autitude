...
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderComponent, ssrRenderAttr } from 'file:///home/ubuntu/Autitude/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        { name: "description", content: "Perguntas frequentes sobre Terapia Ocupacional, Integra\xE7\xE3o Sensorial e nossos servi\xE7os." }
      ]
    });
    const config = {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "faq" }, _attrs))} data-v-f0cc90fe><section class="hero-section" data-v-f0cc90fe><div class="container" data-v-f0cc90fe><div class="section-title" data-v-f0cc90fe><span class="section-tag" data-v-f0cc90fe>Perguntas Frequentes</span><h2 data-v-f0cc90fe>O que Voc\xEA Precisa Saber</h2><p data-v-f0cc90fe>Tire suas d\xFAvidas sobre Terapia Ocupacional e Integra\xE7\xE3o Sensorial.</p></div><div class="faq-categories" data-v-f0cc90fe><!--[-->`);
      ssrRenderList(categories, (category) => {
        _push(`<button class="${ssrRenderClass([{ active: activeCategory.value === category.id }, "category-btn"])}" data-v-f0cc90fe>${ssrInterpolate(category.name)}</button>`);
      });
      _push(`<!--]--></div><div class="faq-list" data-v-f0cc90fe><!--[-->`);
      ssrRenderList(filteredFaqs.value, (faq2, index) => {
        _push(`<div class="${ssrRenderClass([{ open: openFaq.value === index }, "faq-item"])}" data-v-f0cc90fe><div class="faq-question" data-v-f0cc90fe><span class="faq-number" data-v-f0cc90fe>${ssrInterpolate(index + 1)}</span><h3 data-v-f0cc90fe>${ssrInterpolate(faq2.question)}</h3><div class="faq-toggle" data-v-f0cc90fe><span data-v-f0cc90fe></span></div></div><div class="faq-answer" style="${ssrRenderStyle(openFaq.value === index ? null : { display: "none" })}" data-v-f0cc90fe><p data-v-f0cc90fe>${ssrInterpolate(faq2.answer)}</p></div></div>`);
      });
      _push(`<!--]--></div></div></section><section class="sensory-section section" data-v-f0cc90fe><div class="container" data-v-f0cc90fe><div class="section-title" data-v-f0cc90fe><span class="section-tag" data-v-f0cc90fe>Especialidade</span><h2 data-v-f0cc90fe>O que \xE9 Integra\xE7\xE3o Sensorial?</h2></div><div class="sensory-showcase" data-v-f0cc90fe><div class="sensory-text" data-v-f0cc90fe><p data-v-f0cc90fe> A <strong data-v-f0cc90fe>Integra\xE7\xE3o Sensorial</strong> \xE9 uma abordagem terap\xEAutica desenvolvida pela Dra. Jean Ayres, fundamentada na ideia de que o processamento das informa\xE7\xF5es sensoriais \xE9 essencial para o desenvolvimento e comportamento humano. </p><p data-v-f0cc90fe> Quando o c\xE9rebro processa as informa\xE7\xF5es sensoriais de forma desorganizada, a crian\xE7a pode apresentar dificuldades em atividades cotidianas, comportamento desregulado e desafios no aprendizado. </p><h3 data-v-f0cc90fe>Sistema Sensorial</h3><p data-v-f0cc90fe> O sistema sensorial inclui 8 sentidos que trabalham juntos: toque, olfato, paladar, vis\xE3o, audi\xE7\xE3o, propriocep\xE7\xE3o (consci\xEAncia do corpo), vestibular (equil\xEDbrio e movimento) e interocep\xE7\xE3o. </p></div><div class="sensory-signs" data-v-f0cc90fe><h3 data-v-f0cc90fe>Sinais de Regula\xE7\xE3o Sensorial</h3><ul data-v-f0cc90fe><li data-v-f0cc90fe><strong data-v-f0cc90fe>Hiporreativo:</strong> Busca est\xEDmulos intensos, n\xE3o percebe dor/temperatura, bate objetos</li><li data-v-f0cc90fe><strong data-v-f0cc90fe>Hipersens\xEDvel:</strong> Reage excessivamente a ru\xEDdos, texturas, luzes</li><li data-v-f0cc90fe><strong data-v-f0cc90fe>Desorganizado:</strong> Dificuldade em se concentrar, transi\xE7\xF5es</li><li data-v-f0cc90fe><strong data-v-f0cc90fe>Motor:</strong> Coordena\xE7\xE3o ruim, quedas frequentes</li><li data-v-f0cc90fe><strong data-v-f0cc90fe>Alimentar:</strong> Seletividade alimentar extrema</li><li data-v-f0cc90fe><strong data-v-f0cc90fe>Sonoro:</strong> Tapando ouvidos ou procurando barulho</li></ul></div></div><div class="sensory-approach" data-v-f0cc90fe><h3 data-v-f0cc90fe>Abordagem Terap\xEAutica</h3><div class="approach-grid" data-v-f0cc90fe><!--[-->`);
      ssrRenderList(sensoryApproach, (step) => {
        _push(`<div class="approach-step" data-v-f0cc90fe><div class="step-icon" data-v-f0cc90fe><div class="step-icon-inner" data-v-f0cc90fe></div></div><h4 data-v-f0cc90fe>${ssrInterpolate(step.title)}</h4><p data-v-f0cc90fe>${ssrInterpolate(step.description)}</p></div>`);
      });
      _push(`<!--]--></div></div></div></section><section class="cta-section section" data-v-f0cc90fe><div class="container" data-v-f0cc90fe><div class="cta-card" data-v-f0cc90fe>`);
      ...
      _push(`<div class="cta-content" data-v-f0cc90fe><h2 data-v-f0cc90fe>Ainda tem d\xFAvidas?</h2><p data-v-f0cc90fe>Entre em contato conosco para saber como podemos ajudar seu filho.</p><div class="cta-buttons" data-v-f0cc90fe>`);
      ...
      _push(`<a${ssrRenderAttr("href", config.whatsappUrl)} class="btn btn-whatsapp btn-lg" target="_blank" rel="noopener" data-v-f0cc90fe> Falar no WhatsApp </a></div></div></div></div></section></div>`);
    };
  }
};
...
const faq = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f0cc90fe"]]);

export { faq as default };
//# sourceMappingURL=faq-Cd93bBgP.mjs.map
