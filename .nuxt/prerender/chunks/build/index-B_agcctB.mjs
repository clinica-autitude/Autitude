...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrRenderVNode, ssrInterpolate } from 'file:///home/ubuntu/Autitude/node_modules/.pnpm/vue@3.5.35/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home" }, _attrs))} data-v-221a3887><section class="hero" data-v-221a3887><div class="hero-bg" data-v-221a3887>`);
      ...
      _push(`<div class="hero-rings" aria-hidden="true" data-v-221a3887>`);
      ...
      _push(`</div><img${ssrRenderAttr("src", heroLogoUrl)} alt="" class="hero-rings-logo" data-v-221a3887><div class="gradient-blob blob-1" data-v-221a3887></div><div class="gradient-blob blob-2" data-v-221a3887></div><div class="gradient-blob blob-3" data-v-221a3887></div></div><div class="container" data-v-221a3887><div class="hero-wrapper" data-v-221a3887><div class="hero-content" data-v-221a3887><div class="badge-wrapper" data-v-221a3887><span class="hero-badge" data-v-221a3887><span class="badge-dot" data-v-221a3887></span> Cuidado humanizado e baseado em evid\xEAncias </span></div><h1 class="hero-title" data-v-221a3887> Desenvolvimento com <span class="title-highlight" data-v-221a3887>acolhimento,</span> ci\xEAncia e humanidade. </h1><p class="hero-subtitle" data-v-221a3887> A Autitude \xE9 um espa\xE7o especializado no atendimento de crian\xE7as, adolescentes e suas fam\xEDlias, com foco no p\xFAblico neurodivergente. Atuamos com uma abordagem humanizada, integrativa e baseada em evid\xEAncias cient\xEDficas. </p><p class="hero-tagline" data-v-221a3887> \u{1F49C} Cuidamos de pessoas. Potencializamos possibilidades. </p><div class="hero-actions" data-v-221a3887>`);
      ...
      _push(`</div></div><div class="hero-visual" data-v-221a3887><!--[-->`);
      ssrRenderList(pillars, (pillar, index2) => {
        _push(`<div class="${ssrRenderClass([`card-${index2 + 1}`, "visual-card"])}" style="${ssrRenderStyle({ background: pillar.solidColor })}" data-v-221a3887><div class="card-accent" data-v-221a3887>`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(pillar.icon), {
          size: 20,
          class: "card-icon"
        }, null), _parent);
        _push(`</div><div class="card-text" data-v-221a3887>${ssrInterpolate(pillar.title)}</div></div>`);
      });
      _push(`<!--]--></div></div><div class="hero-pillars" data-v-221a3887><p class="pillars-eyebrow" data-v-221a3887>Cada indiv\xEDduo \xE9 \xFAnico. Nosso cuidado tamb\xE9m.</p><div class="pillars-row" data-v-221a3887><!--[-->`);
      ssrRenderList(pillars, (pillar, index2) => {
        _push(`<span class="pillar-chip" data-v-221a3887><span class="pillar-num" data-v-221a3887>${ssrInterpolate(index2 + 1)}</span> ${ssrInterpolate(pillar.title)}</span>`);
      });
      _push(`<!--]--></div></div></div></section><section id="quem-somos" class="about-preview section" data-v-221a3887><div class="container" data-v-221a3887><div class="section-header" data-v-221a3887><div class="header-content" data-v-221a3887><span class="section-tag" data-v-221a3887>Quem somos</span><h2 data-v-221a3887>Cada indiv\xEDduo \xE9 \xFAnico. Nosso cuidado tamb\xE9m.</h2><p data-v-221a3887> A <strong data-v-221a3887>Autitude Desenvolvimento e A\xE7\xE3o Humana</strong> \xE9 um espa\xE7o especializado no atendimento de crian\xE7as, adolescentes e suas fam\xEDlias, com foco no p\xFAblico neurodivergente. </p><p data-v-221a3887> Nossa abordagem \xE9 humanizada, integrativa e baseada em evid\xEAncias cient\xEDficas. </p></div></div><div class="pillars-grid" data-v-221a3887><!--[-->`);
      ssrRenderList(pillars, (pillar, index2) => {
        _push(`<div class="pillar-card" style="${ssrRenderStyle({ "--delay": index2 * 0.1 + "s" })}" data-v-221a3887><div class="pillar-icon-wrapper" style="${ssrRenderStyle({ background: pillar.color })}" data-v-221a3887>`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(pillar.icon), {
          size: 32,
          class: "icon-primary pillar-icon-inner"
        }, null), _parent);
        _push(`</div><div class="pillar-content" data-v-221a3887><h3 data-v-221a3887>${ssrInterpolate(pillar.title)}</h3><p data-v-221a3887>${ssrInterpolate(pillar.description)}</p></div></div>`);
      });
      _push(`<!--]--></div></div></section><section class="services-preview section" data-v-221a3887><div class="container" data-v-221a3887><div class="section-header" data-v-221a3887><div class="header-content" data-v-221a3887><span class="section-tag" data-v-221a3887>Nossas especialidades</span><h2 data-v-221a3887>Um cuidado integrado e interdisciplinar</h2><p data-v-221a3887>Uma equipe multidisciplinar trabalhando em conjunto pelo desenvolvimento de cada pessoa.</p></div></div><div class="services-showcase" data-v-221a3887><div class="service-cards-grid" data-v-221a3887><!--[-->`);
      ssrRenderList(services, (service) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="card-mini-icon" style="${ssrRenderStyle({ background: service.color })}" data-v-221a3887${_scopeId}>`);
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(service.icon), {
                size: 24,
                class: "icon-primary mini-icon-shape"
              }, null), _parent2, _scopeId);
              _push2(`</div><div class="card-mini-content" data-v-221a3887${_scopeId}><h4 data-v-221a3887${_scopeId}>${ssrInterpolate(service.name)}</h4><p data-v-221a3887${_scopeId}>${ssrInterpolate(service.shortDesc)}</p></div><div class="card-arrow" data-v-221a3887${_scopeId}></div>`);
            } else {
              return [
                createVNode("div", {
      ...
      _push(`<!--]--></div></div><div class="section-cta" data-v-221a3887>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/servicos",
        class: "btn btn-secondary btn-lg"
      }, {
      ...
      _push(`</div></div></section><section class="cta-section section" data-v-221a3887><div class="container" data-v-221a3887><div class="cta-wrapper" data-v-221a3887>`);
      ...
      _push(`<div class="cta-content" data-v-221a3887><span class="cta-tag" data-v-221a3887>Autitude \u2014 Desenvolvimento e A\xE7\xE3o Humana</span><h2 data-v-221a3887>Pronto para nos conhecer?</h2><p data-v-221a3887>\u{1F49C} Cuidamos de pessoas. Potencializamos possibilidades.</p><div class="cta-contact" data-v-221a3887><a href="tel:+5512991968683" class="cta-contact-item" data-v-221a3887> \u{1F4F1} (12) 99196-8683 </a><a href="https://www.instagram.com/clinicaautitude" target="_blank" rel="noopener" class="cta-contact-item" data-v-221a3887> \u{1F4F7} @clinicaautitude </a><a href="https://wa.me/5512991968683" target="_blank" rel="noopener" class="cta-contact-item" data-v-221a3887> \u{1F4AC} WhatsApp </a></div><div class="cta-actions" data-v-221a3887>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/agendar",
        class: "btn btn-primary btn-lg"
      }, {
      ...
      _push(`<a${ssrRenderAttr("href", whatsappUrl)} class="btn btn-whatsapp btn-lg" target="_blank" rel="noopener" data-v-221a3887> Falar no WhatsApp </a></div><p class="cta-address" data-v-221a3887> \u{1F4CD} Rua Major Jos\xE9 dos Santos Moreira, 328 \u2014 Vila Rica \u2014 Pindamonhangaba/SP </p></div></div></div></section></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-221a3887"]]);

export { index as default };
//# sourceMappingURL=index-B_agcctB.mjs.map
