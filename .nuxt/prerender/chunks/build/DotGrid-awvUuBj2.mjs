import { defineComponent, useTemplateRef, ref, computed, watch, mergeProps, useSSRContext } from 'file:///home/ubuntu/Autitude/node_modules/.pnpm/vue@3.5.35/node_modules/vue/index.mjs';
...
_postAddChecks = function _postAddChecks(timeline, child) {
  ...
  if (!force && tween._pt && !_reverting$2 && (tween._dur && tween.vars.lazy !== false || !tween._dur && tween.vars.lazy) && _lastRenderedFrame !== _ticker$1.frame) {
...
_isFromOrFromStart = function _isFromOrFromStart(_ref2) {
  ...
  if (ratio !== prevRatio || _reverting$2 || force || tween._zTime === _tinyNum$1 || !totalTime && tween._zTime) {
...
clamp = function clamp(min, max, value) {
  ...
  return value && _isObject$1(value) && "length" in value && (!nonEmpty && !value.length || value.length - 1 in value && _isObject$1(value[0])) && !value.nodeType && value !== _win;
},
...
toArray = function toArray(value, scope, leaveStrings) {
  return _context && !scope && _context.selector ? _context.selector(value) : _isString$1(value) && !leaveStrings && (!_wake()) ? _slice.call((scope || _doc$1).querySelectorAll(value), 0) : _isArray$1(value) ? _flatten(value, leaveStrings) : _isArrayLike(value) ? _slice.call(value, 0) : value ? [value] : [];
},
...
var Animation = /*#__PURE__*/function () {
  ...
  _proto.restart = function restart(includeDelay, suppressEvents) {
    ...
    this._dur || (this._zTime = -_tinyNum$1); // ensures onComplete fires on a zero-duration animation that gets restarted.
        ...
        while (child) {
          ...
          if ((child._act || time >= child._start) && child._ts && pauseTween !== child) {
            ...
            if (time !== this._time || !this._ts && !prevPaused) {
              ...
              pauseTween = 0;
              next && (tTime += this._zTime = -_tinyNum$1); // it didn't finish rendering, so flag zTime as negative so that the next time render() is called it'll be forced (to render any remaining children)
...
_forceAllPropTweens,
  ...
  tween._rEase = reverseEase && (_parseEase$1(reverseEase) || tween._ease);
  ...
  if (!tl || keyframes && !vars.stagger) {
    ...
    if (startAt) {
      ...
      if (!prevStartAt) {
        ...
        if (!immediateRender) {
          _initTween(tween._startAt, _tinyNum$1, _tinyNum$1); //ensures that the initial values are recorded
...
var Tween = /*#__PURE__*/function (_Animation2) {
  ...
  _proto3.render = function render(totalTime, suppressEvents, force) {
    var prevTime = this._time,
        ...
        tTime = totalTime > tDur - _tinyNum$1 && !isNegative ? tDur : totalTime < _tinyNum$1 ? 0 : totalTime,
        time,
        pt,
        iteration,
        cycleDuration,
...
var _gsap = {
  ...
  quickTo: function quickTo(target, property, vars) {
    ...
    var tween = gsap$2.to(target, _setDefaults((_setDefaults2 = {}, _setDefaults2[property] = "+=0.1", _setDefaults2.paused = true, _setDefaults2.stagger = 0, _setDefaults2), vars || {})),
...
_convertToUnit = function _convertToUnit(target, property, value, unit) {
  ...
  if (cache && toPercent && cache.width && horizontal && cache.time === _ticker$1.time && !cache.uncache) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    dotSize: { default: 16 },
    gap: { default: 32 },
    baseColor: { default: "#6B4FA3" },
    activeColor: { default: "#3D2D5E" },
    proximity: { default: 150 },
    speedTrigger: { default: 100 },
    shockRadius: { default: 250 },
    shockStrength: { default: 5 },
    maxSpeed: { default: 5e3 },
    resistance: { default: 750 },
    returnDuration: { default: 1.5 },
    className: { default: "" },
    style: { default: () => ({}) }
  },
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        class: `flex items-center justify-center h-full w-full relative ${__props.className}`,
        style: __props.style
      }, _attrs))}><div class="w-full h-full relative"><canvas class="absolute inset-0 w-full h-full pointer-events-none"></canvas></div></section>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/DotGrid.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=DotGrid-awvUuBj2.mjs.map
